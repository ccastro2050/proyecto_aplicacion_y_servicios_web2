...
> el puerto 8033 (pasa al reiniciar el PC: la API vieja revive sin su
...
> ```
> NAMES                                                 STATUS                    PORTS
> proyecto_aplicacion_y_servicios_web2-api-facturas-1   Up 2 hours                0.0.0.0:8033->8033/tcp
> proyecto_aplicacion_y_servicios_web2-sqlserver-1      Up 2 hours (healthy)      0.0.0.0:11464->1433/tcp
> ```
>
...
│
├── api_facturas/                # LA API (v1 + v2) — C#/ASP.NET Core (puerto 8033)
