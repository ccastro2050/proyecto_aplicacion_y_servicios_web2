...
http://localhost:8033/swagger** (ASP.NET Core la genera con Swashbuckle).
...
La colección usa la variable `base` = `http://localhost:8033` (el proyecto
del curso). Si está probando **SU reconstrucción** (la de la
[GUIA_IA](../docs/spec_kit/versiones/v2_persona_factura/GUIA_IA2.md), que corre en el puerto 8133): clic en la
colección → pestaña **Variables** → cambie `base` a
`http://localhost:8133`. Una sola edición y las 25 peticiones apuntan a su
proyecto.
