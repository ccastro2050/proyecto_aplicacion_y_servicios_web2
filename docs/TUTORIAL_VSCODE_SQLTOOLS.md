...
> [README](../README.md)). SQL Server queda publicado en `localhost,11464`.
...
| Port | `11464` | El puerto del host del compose (`11464:1433`) |
...
> El puerto es la clave: **11464, no 1433**. Dentro de la red de Docker
> la BD escucha en 1433, pero hacia su PC el compose la publica en 11464
...
>
> ```
> Error opening connection Failed to connect to localhost:11464
...
> (`http://localhost:8033/api/producto/PR009`) — un solo dato, muchos
> clientes.
